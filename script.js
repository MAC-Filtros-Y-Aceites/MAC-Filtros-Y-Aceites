...
var products = {
    1: {
        ...
        category: 'filtros',
        description: 'Filtro de aceite flujo completo, especial para transporte liviano.\n\nSu aplicación principal es para la marca CHEVROLET.',
    ...
    2: {
        ...
        category: 'filtros',
        description: 'Filtro de aceite flujo completo, especial para transporte liviano.\n\nSu aplicación principal es para las marcas BYD, CASE/CASE IH, CHERY, CHEVROLET, DAIHATSU, GEELY, GREAT WALL, ISEKI, JOHN DEERE, KAWASAKI, NISSAN, SIMPLICITY, TOYOTA, ZOTIE.',
    ...
    3: {
        ...
        category: 'filtros',
        description: 'Filtro de aceite flujo completo, especial para transporte liviano.\n\nSu aplicación principal es para las marcas CHEVROLET, DAEWOO, GMC, HYSTER.',
    ...
    4: {
        ...
        category: 'filtros',
        description: 'Filtro de aceite flujo completo, especial para transporte liviano.\n\nSu aplicación principal es para las marcas AUSA, BOBCAT, CHEVROLET, GEHL, GENIE, HITACHI, HONDA, INGERSOLLRAND, JOHN DEERE, KAESER, KOMATSU, KUBOTA, MAZDA, MCCORMICK, MITSUBISHI, TENNANT,TORO, WESTERBEKE.',
    ...
    5: {
        ...
        category: 'filtros',
        description: 'Filtro de aceite flujo completo, especial para transporte liviano.\nSu aplicación principal es para las marcas CASE/CASE IH, CITROEN, DEUTZ-FAHR, FIAT, GREAT WALL, HITACHI, HONDA, HUERLIMANN TRACTORS, HYUNDAI, IHI, JAC, KOMATSU, MASSEY FERGUSON, MAZDA, MITSUBISHI, NEUSON, NISSAN, POLARIS, SAME, TORO, YANMAR.',
    ...
    6: {
        ...
        category: 'filtros',
        description: 'Filtro de aceite flujo completo, especial para transporte liviano.\n\nSu aplicación principal es para las marcas CHERY, CHEVROLET, FORD, JEEP, MCCORMICK, SKODA, SULLAIR, SUNWARD, SUZUKI, TOYOTA, VOLKSWAGEN.',
    ...
    7: {
        ...
        category: 'filtros',
        description: 'Filtro de aceite flujo completo, especial para transporte mediano.\n\nSu aplicación principal es para las marcas CHEVROLET, CLARK, DETROIT DIESEL, HINO, ISUZU.',
    ...
    8: {
        ...
        category: 'filtros',
        description: 'Filtro de aire primario, cilíndrico. Especial para transporte mediano.\n\nSu aplicación principal es para las marcas CHEVROLET, GMC, HITACHI, IHI, ISUZU, JAC, JCB, KUBOTA, NISSAN.',
    ...
    9: {
        ...
        category: 'filtros',
        description: 'Filtro de aire primario, panel rígido. Especial para transporte liviano.\n\nSu aplicación principal es para la marca CHEVROLET.',
    ...
    10: {
        ...
        title: 'Filtro de aire\nAP0978',
        category: 'filtros',
        description: 'Filtro de aire primario, panel flexible. Especial para transporte liviano.\n\nSu aplicación principal es para las marcas DACIA, RENAULT.',
    ...
    12: {
        ...
        category: 'filtros',
        description: 'Filtro de aire primario, panel flexible. Especial para transporte liviano.\n\nSu aplicación principal es para las marcas RENAULT, SSANGYONG.',
    ...
    13: {
        ...
        category: 'filtros',
        description: 'Filtro de aire primario, cilíndrico. Especial para transporte liviano diésel.\n\nSu aplicación principal es para las marcas FORD, MAZDA, TOYOTA.',
    ...
    14: {
        ...
        category: 'filtros',
        description: 'Filtro de combustible gasolina. Especial para transporte liviano.\n\nSu aplicación principal es para las marcas CHANGAN, CHERY, CHEVROLET, DAEWOO, FIAT, FOTON, HONDA, JEEP, MAZDA.',
    ...
    15: {
        ...
        category: 'filtros',
        description: 'Filtro de combustible primario. Especial para transporte mediano. \n\nSu aplicación principal es para las marcas ISUZU, KOMATSU, NISSAN, ROSCO, TOYOTA.',
    ...
    16: {
        ...
        category: 'filtros',
        description: 'Filtro de combustible primario. Especial para transporte mediano. \n\nSu aplicación principal es para las marcas AGRALE, ALLIS-CHALMERS, ASKAM KAMYON, ATLAS COPCO, ATLAS WEYHAUSEN, BARREIROS, BAUMANN,BERTHOUD, BMC, BOBCAT, BUEHRER, CARRARO, CASE/CASE IH, CHAMPION ROAD, CLARK, COMPAIR, DEMAG, DENNIS, DEUTZ, DEUTZ-FAHR, DITCH WITCH, DOPPSTADT, DYNAPAC, EICHER, FENDT, FIATALLIS, FORD, FOTON, FREEMAN, GENIE, GOLDO TRACTORS, HAMM, HITACHI, HOLDER TRACTORS, HUERLIMANN TRACTORS,IKARUS, IRISBUS, IVECO, JELCZ, KALMAR, KENWORTH, KOMATSU, KRAMER, LIEBHERR, LINDE, MANITOU,MENGELE, ORENSTEIN & KOPPEL, PEGASO, REFORM-WERKE, RENAULT VI, ROMAN, SAMBRON, SAME, SCHANZLIN, STEINBOCK, STILL, TIMBERJACK, VALMET, VOLKSWAGEN,VOLVO, WHITE.',
    ...
    17: {
        ...
        category: 'filtros',
        description: 'Filtro de combustible primario. Especial para transporte liviano diésel. \n\nSu aplicación principal es para las marcas CHEVROLET, ISUZU, MITSUBISHI, TOYOTA.',
    ...
    18: {
        ...
        category: 'filtros',
        description: 'Filtro separador agua combustible con sensor. Especial para transporte liviano. \n\nSu aplicación principal es para las marcas ASIA, CATERPILLAR, CHEVROLET, DAIHATSU, GMC, HITACHI, HYSTER.',
    ...
    19: {
        ...
        category: 'filtros',
        description: 'Filtro de aire primario, panel rígido. Especial para transporte liviano. \n\nSu aplicación principal es para la marca MAZDA.',
    ...
    20: {
        ...
        category: 'filtros',
        description: 'Filtro de aire acondicionado de cabina, panel rígido. Especial para transporte liviano. \n\nSu aplicación principal es para la marca RENAULT.',
    ...
    21: {
        ...
        category: 'filtros',
        description: 'Filtro de aire acondicionado de cabina, panel rígido. Especial para transporte liviano. \n\nSu aplicación principal es para la marca NISSAN.',
    ...
    22: {
        ...
        category: 'filtros',
        description: 'Filtro de aire acondicionado de cabina, panel rígido. Especial para transporte liviano. \n\nSu aplicación principal es para la marca SUBARU, TOYOTA.',
    ...
    25: {
        ...
        category: 'aceites',
        description: 'HIDRAULICO ISO68 ofrece protección antidesgaste, lo que reduce los costos de mantenimiento al minimizar el desgaste de los componentes. Su resistencia a la oxidación prolonga la vida útil del lubricante y del sistema hidráulico.<br><br><strong>BENEFICIOS</strong><br><br>Ideal para sistemas hidrostáticos de alta presión, proporcionando lubricación eficiente y protección contra la corrosión y la oxidación, asegurando así un rendimiento fiable en diversas aplicaciones industriales y de vehículos.<br><br><strong>TAMAÑO:</strong> Galón',
        additionalImg: ''  // Imagen adicional
    },
    26: {
    ...
    27: {
        ...
        description: 'MOTOCOOLER LIQUIDO REFRIGERANTE Ofrece protección contra la corrosión de los componentes metálicos presentes en el motor como en el circuito de refrigeración.<br><br><strong>TAMAÑO:</strong> Un cuarto',
        additionalImg: ''  // Imagen adicional
    },
    28: {
